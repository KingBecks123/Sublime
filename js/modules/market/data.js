    ...
    <div id="marketStore">
        ...
        <div id="patrician">
            ...
            <div class="basicDiv" id="unlockBenevolence">
                <button class="travelButton" onclick="buy('unlockBenevolence', 5e5)">Buy a conscience</button>
            ...
            <div class="basicDiv" id="surveillanceCamera2">
                <button class="travelButton" onclick="buy('surveillanceCamera2', 2e5)">Buy A High Tech Surveillance Camera</button>
